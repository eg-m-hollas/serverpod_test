...
class MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    connectionHandler = StreamingConnectionHandler(
        client: client, listener: (_) => setState(() {}));
  ...
  Widget _buildUser(User? user) => Column(
        children: [
          CircleAvatar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          child: imageController == null
              ...
              : PixelEditor(
                  ...
                  onSetPixel: (details) {
                    client.pixorama.sendStreamMessage(ImageUpdate(
      ...
      //       ElevatedButton(
      //         onPressed: () async {
      //           final result = await api.create(User(
      //               name: 'Mark',
      //               image:
      ...
      //           user!.image =
      //               'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80';
      //           final result = await api.update(user!);
      //           debugPrint(result.toString());
